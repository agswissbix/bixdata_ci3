...
<style type="text/css">
    ...
    #contratto_missione_content textarea {
        width: 100%;
...
<div id="contratto_missione_content" class="print_page contratto_missione_content_3" style="">
    ...
    <div class='print_page_content'>
        ...
        <div class="row" style="margin-bottom: 0px">
            ...
            <div class="col s11">
                ...
                {
                ?>
                    <textarea id="indennitapasto" name="fields[indennitachilometrca]"  ><?=$fields['indennitachilometrca']?></textarea>
                <?php
                }
                else
                {
                    $fields['indennitachilometrca']=nl2br($fields['indennitachilometrca']);
                ?>
                    <div  style="margin-left: 20px;" ><?=$fields['indennitachilometrca']?></div>
                <?php
                }
                ?>
            </div>
        ...
        <div class="row" style="margin-bottom: 0px">
            ...
            <div class="col s11">
                ...
                {
                ?>
                    <textarea id="indennitapasto" name="fields[indennitapasto]"  style="margin-left: 20px;" ><?=$fields['indennitapasto']?></textarea>
                <?php
                }
                else
                {
                    $fields['indennitapasto']=nl2br($fields['indennitapasto']);
                ?>
                    <div  style="margin-left: 20px;" ><?=$fields['indennitapasto']?></div>
                <?php
                }
                ?>
        ...
        <div class="row" style="margin-bottom: 0px">
            ...
            <div class="col s11">
                ...
                {
                ?>
                    <textarea id="indennitapasto" name="fields[indennitaaltre]"  style="margin-left: 20px;" ><?=$fields['indennitaaltre']?></textarea>
                <?php
                }
                else
                {
                    $fields['indennitaaltre']=nl2br($fields['indennitaaltre']);
                ?>
                    <div  style="margin-left: 20px;" ><?=$fields['indennitaaltre']?></div>
                <?php
                }
                ?>
            </div>
